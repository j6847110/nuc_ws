...
class Obstacle_Avoidance(Node):
    ...
    def obs_labels_callback(self, msg):
        ...
        self.obs_labels = np.flip(self.obs_labels)
    ...
    def obs_r_callback(self, msg):
        ...
        self.obs_r = np.flip(np.array(msg.data))
    ...
    def pub_des(self):
        ...
        err_g =np.array([self.odom_pos[0]-self.odom_wp_x_set[self.cur_wp_idx],

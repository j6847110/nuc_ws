...
class Obstacle_Avoidance(Node):
    ...
    def __init__(self):
        ...
        #wp variable
        self.odom_wp_x_set = [10,5, 5, 1, 0]
        self.odom_wp_y_set = [0, -1,-5,-5, 0]
        self.wp_clear = False
    ...
    def pub_des(self):
        ...
        #cur_pos
        #self.heading
        err = [self.odom_pos[0]-self.odom_wp_x_set[self.cur_wp_idx],
        ...
        err_x = Float64()
        err_x.data = self.err_x
        self.err_x_pub.publish(err_x)

        err_y = Float64()
        err_y.data = self.err_y
        self.err_y_pub.publish(err_y)
